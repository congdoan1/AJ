 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://service.sample/", wsdlLocation = "http://localhost:8080/Day11JWSE0866/CalculatorWebService/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://service.sample/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Day11JWSE0866/CalculatorWebService/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://service.sample/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sample/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
