...
public class SearchItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String dFrom = request.getParameter("txtFrom");
            //DateFormat d = new SimpleDateFormat("yyyy-MM-dd");
            //Date f = Date.parse(dFrom);
            String dTo = request.getParameter("txtTo");
            try {
                Context context = new InitialContext();
                Object obj = context.lookup("ItemJNDI");
                ItemSessionBeanRemote poji = (ItemSessionBeanRemote) obj;
                List result = poji.searchByDate(new Date(Date.parse(dFrom)), new Date(Date.parse(dTo)));
